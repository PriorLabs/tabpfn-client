...
TABPFN_CLIENT_POLL_INTERVAL = float(os.getenv("TABPFN_CLIENT_POLL_INTERVAL", 5.0))
TABPFN_CLIENT_POLL_TIMEOUT = float(
    os.getenv("TABPFN_CLIENT_POLL_TIMEOUT", 7200.0)  # 2 hours
)

_ASYNC_MODE_ENABLED_ABOVE_SIZE_BYTES = 50 * 1024 * 1024
